...
<table class="table table-bordered text-center align-middle">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <span class="badge bg-primary">{{ $pengguna->jurusan ?? 'Teknik Informatika' }}</span>
            </td>
            <td>
                <span>{{ $pengguna->peminatan ?? 'Software Engineer' }}</span>
            </td>
            <td>
        ...
        function formatDate(isoString) {
            ...
            modalBody.innerHTML = `
                <table class="table table-striped table-sm">
                    ...
                    <tr><th>Pengguna</th><td>${data.nama}</td></tr>
                    <tr><th>NIM</th><td>${data.nim}</td></tr>
                    <tr><th>Email</th><td>${data.email}</td></tr>
                    <tr><th>No Telp</th><td>${data.telp}</td></tr>
                    <tr><th>Jurusan</th><td>${data.jurusan ?? 'Teknik Informatika'}</td></tr>
                    <tr><th>Peminatan</th><td>${data.peminatan ?? 'Software Engineer'}</td></tr>
